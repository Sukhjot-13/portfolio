...
//   ];
//   const items = [
//     <SiReact key="react" size={60} className="text-blue-500" />,
//     <SiNextdotjs key="nextjs" size={60} className="text-black" />,
//     <SiHtml5 key="html5" size={60} className="text-red-500" />,
//     <SiCss3 key="css3" size={60} className="text-blue-600" />,
//     <SiJavascript key="javascript" size={60} className="text-yellow-500" />,
//     <SiFirebase key="firebase" size={60} className="text-yellow-600" />,
//     <SiAuth0 key="auth0" size={60} className="text-orange-500" />,
//   ];
...
//             Tech Stack
//           </h3>
//           <Slider items={items} reverse={false} width={60} height={60} />
//         </div>
//         <div className="p-5 lg:p-7">
//           <h3 className="mb-7 text-xl font-bold text-primary-heading ">
//             Certifications
