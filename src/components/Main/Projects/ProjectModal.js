...
//   return (
//     <div className=" text-lg bg-tertiary-bg relative p-4 mt-7 pt-7 w-[95vw] h-[90dvh] rounded-xl scrollbar-thin overflow-x-auto md:w-[60vw]">
//       <p
//         onClick={hideModal}
...
//               alt="project"
//               className="cover w-full h-full md:w-72 md:h-72 object-cover "
//             />
//           </div>
